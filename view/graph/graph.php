...
$oi = $graph->makePercent();

$text = $graph->loadTextQuestionNames();

$teacher = $graph->loadTeacherInfo();

$nota = $graph->makeNotaTeacher();
?>
<div class="container-narrow">
    <div class="jumbotron">
        ...
        <form name="form1" method="post" onSubmit="return validaRadio();">
            ...
            <h3>Graficos para o(a) professor(a) <?php echo $teacher[0]['nomeProfessor']; ?> </h3>
...
<div id="content">
    ...
    ?>
        ...
        <div class="demo-container">
            <script>
                geraNota('#nota', <?php echo $nota['MB'] ?>,<?php echo $nota['B'] ?>,<?php echo $nota['R']?>,<?php echo $nota['I']?>)
            </script>
